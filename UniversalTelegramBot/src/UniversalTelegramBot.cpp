...
// bool UniversalTelegramBot::replyToMessage(const String& chat_id, const String& message_id,const String& text,){

// }


bool UniversalTelegramBot::sendMessage(const String& chat_id, const String& text,
                                       const String& parse_mode, int reply_id, int message_id) { // added message_id
